            ...
            <div>
              ...
              <ul className="space-y-1.5 text-[11px] text-slate-400">
                <li className="flex items-center gap-1.5">
                  ...
                  <span>Telegram: <a href="https://t.me/smartsalerbot" target="_blank" rel="noopener noreferrer" className="text-white hover:underline">@smartsalerbot</a></span>
                </li>
                <li className="flex items-center gap-1.5">
                  <Phone className="w-3 h-3 text-emerald-400" />
                  <span>WhatsApp / Телефон: <a href="tel:+992900007799" className="text-white hover:underline font-mono">+992 (90) 000-77-99</a></span>
                </li>
                <li>Офис: г. Душанбе, Таджикистан</li>
                <li>Техподдержка 24/7 для активных клиентов</li>
              </ul>
            </div>
            ...
            {formSuccess ? (
              <div className="py-6 text-center">
                ...
                <p className="text-slate-600 text-xs mt-1.5 leading-relaxed">
                  Спасибо! Мы свяжемся с вами в течение 15 минут в WhatsApp или Telegram и предоставим доступ к демо-системе.
                </p>
                <button
